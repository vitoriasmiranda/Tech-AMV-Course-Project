...
public class SistemaTechAMV {
    ...
    private static List<Usuario> usuarios = DadosIniciais.carregarUsuarios();
    private static List<Produto> produtos = DadosIniciais.carregarProdutos();
    private static List<Cliente> clientes = DadosIniciais.carregarClientes();
    private static List<Fornecedor> fornecedores = DadosIniciais.carregarFornecedores();
